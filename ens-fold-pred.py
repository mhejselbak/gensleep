    ...
    for fold_idx in range(5):
        ...
        for i in range(n_subjects_per_fold):
            y_pred, y_true = predict(
                data_dir="/sleep-edf-data/physionet_sleep/test-14-pz",
            ...
            y_pred2, _ = predict(
                data_dir="/sleep-edf-data/physionet_sleep/test-14-eog",
            ...
            y_pred3,_ = predict(
                data_dir="/sleep-edf-data/physionet_sleep/test-14-fpz",

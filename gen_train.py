...
tf.app.flags.DEFINE_integer('pretrain_epochs', 40,
...
def pretrain(n_epochs, fold_idx,output_dir):
    trainer = GenFeatureNetTrainer(
        ...
        sr=FLAGS.sr,
        interval_plot_filter=40,
        interval_save_model=n_epochs/2,
...
def finetune(model_path, n_epochs,fold_idx,output_dir):

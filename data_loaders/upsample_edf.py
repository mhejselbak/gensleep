...
def main():
    ...
    full = os.listdir('/media/sune/Data/Glostrup/sleep-edf-data/physionet_sleep/eeg_fpz_cz')
    train = os.listdir('/media/sune/Data/Glostrup/sleep-edf-data/physionet_sleep/25subj-256-newtest-fpz')
#/media/sune/Data/Glostrup/sleep-edf-data/physionet_sleep/
    test = list(set(full)-set(train))
    resample_npz(test,args.hz,args.output_dir,args.data_dir)

...
def main():
    ...
    parser.add_argument("--data_dir", type=str, default="/media/sune/Data/Glostrup/sleep-edf-data/",
                        help="File path to the CSV or NPY file that contains walking data.")
    parser.add_argument("--output_dir", type=str, default="/media/sune/Data/Glostrup/sleep-edf-data/physionet_sleep/test-14-pz",
